...
def main():
    ...
    while run:
        clock.tick(FPS)
        keys_pressed = pygame.key.get_pressed()  # Retrieve the keys pressed
        ...
        yellow_handle_movement(yellow, keys_pressed)  # Pass keys_pressed as an argument
        red_handle_movement(red, keys_pressed)  # Pass keys_pressed as an argument
